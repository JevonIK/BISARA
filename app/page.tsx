            ...
            <div className="relative flex flex-col justify-center overflow-hidden rounded-3xl border border-[#FCE5B5] bg-[#FFF8EA] p-5 shadow-2xs sm:p-6 lg:p-7">
              <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
                <div>
                  ...
                  <p className="mt-3 text-xs font-bold uppercase tracking-widest text-slate-900">
                  ...
                  <div className="mt-4 sm:mt-5">
                    <Link
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-[#F8A51D] px-5 py-2.5 text-xs sm:text-sm font-bold text-slate-900 shadow-sm transition-transform hover:bg-[#E59312] hover:scale-105 active:scale-95"
                    >
